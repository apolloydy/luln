...
const CancerStatistics = () => {
    ...
    return (
        <div className="p-6 flex flex-col items-center w-full">
            <h1 className="text-3xl font-bold mb-6 text-white">Cancer Death Statistics (2022)</h1>

            {/* 男性癌症饼图 */}
            <div className="mb-12 w-full max-w-4xl">
                <h2 className="text-2xl font-semibold mb-4 text-white">Male Cancer Death Causes</h2>
                <div className="relative w-full" style={{ maxWidth: "600px", height: "400px" }}>
                    <Pie data={createChartData(maleCancerCauses)} options={chartOptions} />
                </div>
            </div>

            {/* 女性癌症饼图 */}
            <div className="w-full max-w-4xl">
                <h2 className="text-2xl font-semibold mb-4 text-white">Female Cancer Death Causes</h2>
                <div className="relative w-full" style={{ maxWidth: "600px", height: "400px" }}>
                    <Pie data={createChartData(femaleCancerCauses)} options={chartOptions} />
                </div>
            </div>
        </div>
    );
